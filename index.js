(function() {
  ...
  var verticeTriangle = new Float32Array([
      //x,y,z                  //r,g,b
      -0.2,  +0.5,  +0.0,      0.0, 1.0, 0.8,  
      -0.1,  +0.5,  +0.0,      0.0, 1.0, 0.8,  
      -0.2,  -0.5,  +0.0,      0.0, 1.0, 0.8,  
      -0.2,  -0.5,  +0.0,      0.0, 1.0, 0.8,  
      -0.1,  +0.5,  +0.0,      0.0, 1.0, 0.8,  
      -0.1,  -0.5,  +0.0,      0.0, 1.0, 0.8,  
      -0.1,  -0.5,  +0.0,      0.0, 1.0, 0.8,  
      -0.1,  -0.4,  +0.0,      0.0, 1.0, 0.8,  
      +0.25, -0.4,  +0.0,      0.0, 1.0, 0.8,  
      -0.1,  -0.5,  +0.0,      0.0, 1.0, 0.8,  
      +0.25, -0.5,  +0.0,      0.0, 1.0, 0.8,  
      +0.25, -0.4,  +0.0,      0.0, 1.0, 0.8,  
      ]);
  ...
  function draw(){
    ...
    ac = glMatrix.vec3.fromValues(0.17, 0.40, 0.38);  //NRP 05111740000038
